...
import { Trophy, ArrowRight, Loader2, Search, Users, Clock, Tag, LogIn } from 'lucide-react';
...
export default function HackathonsPage() {
    ...
    }, [fetchHackathons, user, authLoading]);
            ...
            return (
                <Card>
                    <CardHeader className="text-center">
                        ...
                        <CardContent>
                            <p className="mb-4">You must be logged in to view hackathons.</p>
                            <Button asChild>
