...
import { Loader2, Filter, Calendar as CalendarIcon, LogIn } from 'lucide-react';
            ...
            return (
                <Card className="max-w-md mx-auto text-center">
                    <CardHeader>
                        ...
                        <CardDescription>You must be logged in to view the events calendar.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Button asChild>
