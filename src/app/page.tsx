...
// const CapstoneProject = dynamic(() => import('@/components/capstone-project'), {
//   loading: () => <Skeleton className="w-full h-[200px]" />,
// });
  ...
  if (user) {
    return (
      <>
        ...
        {/* <section id="capstone">
          <h2 className='text-3xl font-bold tracking-tight text-center'>Capstone Projects </h2>
          <p className='text-center'> Upload your capstone projects here <a className='text-underline text-blue-500 pointer' href='saveethahub.tech'> upload</a></p>
          <CapstoneProject />
        </section>
         */}
        <Features />
